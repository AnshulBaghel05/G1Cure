...
```bash
git remote add encore encore://g1cure-healthcare-saas-qahi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/g1cure-healthcare-saas-qahi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/g1cure-healthcare-saas-qahi/settings/integrations/github)
